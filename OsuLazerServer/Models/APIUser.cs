...
public class APIUser
{
    ...
    [JsonPropertyName("last_visit")] public object LastVisit { get; set; }

    [JsonPropertyName("pm_friends_only")] public bool PmFriendsOnly { get; set; }

    [JsonPropertyName("profile_colour")] public object ProfileColour { get; set; }

    [JsonPropertyName("username")] public string Username { get; set; }

    [JsonPropertyName("cover_url")] public string CoverUrl { get; set; }

    [JsonPropertyName("discord")] public object Discord { get; set; }
    ...
    [JsonPropertyName("title_url")] public object TitleUrl { get; set; }
    ...
    [JsonPropertyName("account_history")] public List<object> AccountHistory { get; set; }
